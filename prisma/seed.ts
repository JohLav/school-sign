...
async function main() {
  ...
  //     firstname: "James",
  //     lastname: "Smith",
  //     email: "james.smith@lakeside.edu",
  //     password: "Securepassword$7",
  //     role: Role.TEACHER,
  //     schoolId: school5.id,
  //     classId: class5.id,
  ...
  //     firstname: "Emily",
  //     lastname: "Jonhson",
  //     email: "emily.johnson@lakeside.edu",
  //     password: "Securepassword$7",
  //     role: Role.TEACHER,
  //     schoolId: school5.id,
  //     classId: class5.id,
  ...
  //     firstname: "Robert",
  //     lastname: "Williams",
  //     email: "robert.williams@lakeside.edu",
  //     password: "Securepassword$7",
  //     role: Role.TEACHER,
  //     schoolId: school5.id,
  //     classId: class5.id,
  ...
  //     firstname: "Sophia",
  //     lastname: "Brown",
  //     email: "sophia.brown@lakeside.edu",
  //     password: "Securepassword$7",
  //     role: Role.TEACHER,
  //     schoolId: school5.id,
  //     classId: class5.id,
  ...
  //     firstname: "Olivia",
  //     lastname: "Garcia",
  //     email: "olivia.garcia@lakeside.edu",
  //     password: "Securepassword$7",
  //     role: Role.TEACHER,
  //     schoolId: school5.id,
  //     classId: class5.id,
